...
class Post(db.Model):
    ...
    timestamp = db.Column(db.String(100), index=True, default=datetime.utcnow)
    user_id = db.Column(db.Integer, db.ForeignKey('users.id'))
    primary_tags = db.Column(db.String(800))
    secondary_tags = db.Column(db.String(800))
    ...
    def save_changes(self, form, file, userId, new=False):
        ...
        self.user_id = userId
        self.primary_tags = form.primary_tags.data
        self.secondary_tags = form.secondary_tags.data
...
class Profile(db.Model):
    ...
    def save_changes(self, form, file, new=False):
